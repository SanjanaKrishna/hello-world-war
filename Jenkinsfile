        ...
        stage('DEPLOY') {
            steps {  agent { label 'dev' }
                script {
                    ...
                    sh """
                    scp -r /home/ubuntu/jenkins/workspace/pileline_master_slave/target/hello-world-war-1.0.0.war ubuntu@172.31.6.200:/home/ubuntu/apache-tomcat-10.1.34/webapps/
