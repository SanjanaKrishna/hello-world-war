pipeline {
    ...
    environment {
        ...
        DOCKER_HUB_REPO = "sanjanabn25/ubuntu_images" // Replace with your Docker Hub repository
        DOCKER_HUB_CREDENTIALS = "docker_hub" // Jenkins credential ID for Docker Hub
        IMAGE_TAG = "v2" // Tag for the Docker image
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git 'https://github.com/SanjanaKrishna/hello-world-war.git' // Replace with your repository URL
            }
        }
